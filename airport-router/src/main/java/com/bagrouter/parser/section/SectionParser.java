...
import com.bagrouter.parser.section.RowParsingDelegate;
import com.bagrouter.parser.section.SectionEntry;
import com.bagrouter.parser.section.SectionParsingConsumer;
...
public class SectionParser {
	 ...
	 * Add a row parsing consumer for a given type.
	 */
	public void addSectionConsumer( SectionType type, RowParsingDelegate<? extends SectionEntry> parsingDelegate, 
			SectionParsingConsumer<SectionEntry> consumer ) {
